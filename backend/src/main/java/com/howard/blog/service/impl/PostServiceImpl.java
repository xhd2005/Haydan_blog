...
import com.howard.blog.mapper.CategoryMapper;
import com.howard.blog.mapper.PostMapper;
import com.howard.blog.mapper.PostTagMapper;
import com.howard.blog.mapper.TagMapper;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public PostDetailVO getPostBySlug(String slug) {
        ...
        if (post == null) {
            throw new BusinessException(404, "文章不存在: " + slug);
        }
