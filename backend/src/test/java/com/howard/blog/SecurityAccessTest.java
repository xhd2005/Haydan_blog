...
import com.howard.blog.dto.RegisterRequest;
...
public class SecurityAccessTest {
    ...
    void testHorizontalPrivilegeEscalationCommentDelete() throws Exception {
        ...
        com.howard.blog.entity.User user1 = userService.getOne(
                new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.howard.blog.entity.User>()
                        .eq(com.howard.blog.entity.User::getUsername, "reader_test1"));
