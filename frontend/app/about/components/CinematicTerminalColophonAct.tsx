...
export function CinematicTerminalColophonAct() {
  ...
  return (
    <section id="act-terminal" className="relative py-20 sm:py-28 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      
      {/* 背景微晕 */}
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="w-[600px] h-[350px] bg-gradient-to-tr from-emerald-500/10 via-teal-500/10 to-transparent rounded-full blur-3xl opacity-70" />
      </div>
      ...
      <div className="relative z-10 space-y-12">
        ...
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-mono tracking-widest uppercase font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 border border-emerald-500/20">
            ...
            ACT 04 · PHILOSOPHY & GEEK TERMINAL DECK
          </div>

          <blockquote className="space-y-4">
            <p className="text-2xl sm:text-4xl md:text-5xl font-serif text-slate-900 dark:text-white leading-relaxed max-w-3xl mx-auto">
              “以第一性原理叩问代码，在自然旷野中校准心智。”
            </p>
            <p className="text-sm sm:text-base font-serif italic text-slate-500 dark:text-neutral-400 max-w-xl mx-auto">
        ...
        {/* ================= 2. 深度内嵌极客交互命令行终端 (Geek Terminal Deck) ================= */}
        <div className="text-left max-w-4xl mx-auto">
          <div className="relative group">
            {/* 终端周围环境氛围流光 */}
            <div className="absolute -inset-1 rounded-[32px] bg-gradient-to-r from-emerald-500/20 via-teal-500/15 to-cyan-500/20 blur-xl opacity-50 group-hover:opacity-80 transition duration-700 pointer-events-none" />
        ...
        {/* ================= 3. 苹果高定悬浮联络坞 (Apple Floating Dock) ================= */}
        ...
        {/* ================= 4. 极简版权与纯正标识 ================= */}
        <div className="pt-8 text-xs font-mono text-slate-400 dark:text-neutral-500 space-y-1">
          ...
          <p className="flex items-center justify-center gap-1 text-[11px] opacity-75">
            ...
            <span>Next.js 14, Java 25 & High-concurrency Passion.</span>
          </p>
        </div>
